...
CREATE TABLE `users` (
  ...
  CONSTRAINT type_chk CHECK (type IN('admin', 'seller', 'client'))
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `type`, `address`, `wallet_balance`) VALUES
(1, 'Rum_Thompson', 'admin01@shopnow.com', '$2y$10$39uEH/Yzh6AC2ygxO/LDB.F8HxFoqpeG3cEvl83NbBrXWdXNtF0Lm', 'admin', 'ShopNowoffice 12 St.', 0);
...
CREATE TABLE `shops` (
  ...
  `updated_at` DATE,
  CONSTRAINT sell_prod FOREIGN KEY (seller_id) REFERENCES users(id)
)
...
-- (2, '2014_10_12_100000_create_wishlist_table', 1),
-- (3, '2019_08_19_000000_create_buy_history_table', 1),
-- (4, '2019_12_14_000001_create_rating_table', 1),
-- (5, '2024_02_07_174228_create_categories_table', 6),
-- (6, '2024_04_09_074954_create_shops_table', 10),
-- (7, '2024_04_14_193209_create_products_table', 11);
